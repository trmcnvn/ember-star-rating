...
return Ember.get(this,"wholeOnly")?Math.ceil(r):r}},_getPositionFromEvent:function(e){return e instanceof TouchEvent&&e.changedTouches[0]?e.changedTouches[0].pageX:e.pageX},_getTarget:function(e){var t=Ember.get(this,"numStars"),n=t*(e-this.element.getBoundingClientRect().left)/parseInt(getComputedStyle(this.element).width,10)+.5
